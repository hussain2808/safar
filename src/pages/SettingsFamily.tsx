  ...
  return (
    <div className="min-h-screen bg-cream">
      <header className="px-2 pt-12 pb-4 flex items-center gap-2">
        ...
        <h1 className="font-serif text-page-title text-text-primary">Family</h1>
      </header>

      <main className="px-4 pb-12">
        <section>
          <div className="flex items-center justify-between mb-3">
            <p className="text-caption text-text-secondary">Who your documents and items belong to.</p>
