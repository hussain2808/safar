    ...
    <div className="min-h-screen bg-cream flex flex-col">
      <header className="px-5 pt-6 pb-4 flex items-start justify-between">
        <div className="flex items-start gap-2">
          ...
          <div>
            <h1 className="font-serif text-[30px] font-bold text-text-primary leading-tight">Amaanat</h1>
            <p className="text-caption text-text-secondary mt-1">Everything entrusted to your care</p>
          </div>
        </div>
