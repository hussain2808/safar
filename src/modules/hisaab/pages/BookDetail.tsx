      ...
      <header className="px-2 pt-12 pb-3 flex items-center gap-2 flex-shrink-0">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            <span className="text-body text-hisaabText-primary truncate">{book.name}</span>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between px-2 pb-2">
                      <p className="text-caption text-hisaabText-secondary uppercase tracking-wide">{group.month}</p>
