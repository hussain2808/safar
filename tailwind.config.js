...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'user-name': ['48px', { fontWeight: '400', letterSpacing: '-0.5px', lineHeight: '1.15' }],
        'module-name': ['32px', { fontWeight: '400', letterSpacing: '-0.3px', lineHeight: '1.2' }],
        'book-name': ['24px', { fontWeight: '400', lineHeight: '1.25' }],
        'page-title': ['30px', { fontWeight: '700', letterSpacing: '-0.3px', lineHeight: '1.2' }],
        'section-heading': ['19px', { fontWeight: '600', lineHeight: '1.3' }],
        'amount-lg': ['32px', { fontWeight: '700' }],
        'amount-md': ['28px', { fontWeight: '700' }],
        'amount-sm': ['24px', { fontWeight: '700' }],
